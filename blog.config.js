...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个旅行者, Hi，我是一个打工人,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '畏无敌', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '诶嘿', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.654147.xyz', // 网站地址
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '沪ICP备20009945号-1', // 备案号 闽ICP备XXXXXXX
  ...
  ANALYTICS_BAIDU_ID: process.env.NEXT_PUBLIC_ANALYTICS_BAIDU_ID || 'd3bcff43d5cf9f5ba5db59c0a9ea3d2e', // e.g 只需要填写百度统计的id，[baidu_id] -> https://hm.baidu.com/hm.js?[baidu_id]
  ...
  // 谷歌广告
  ADSENSE_GOOGLE_ID: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || 'ca-pub-3406223950592331', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
